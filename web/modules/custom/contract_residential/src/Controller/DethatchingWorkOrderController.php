...
/**
 * Controller for creating "Dethatching" work orders.
 */
class DethatchingWorkOrderController extends ControllerBase {

  /**
   * Creates a "Dethatching" work order for a given contract.
   *
   ...
   */
  public function createDethatchingWorkOrder($contract_id) {
    ...
    // Get the value of the 'field_dethatching_season' field from the Pre-emergent entity.
    $contract_season = $dethatching_section->get('field_dethatching_season')->target_id;
    ...
    $work_order = $entity_type_manager->getStorage('work_order')->create([
      ...
      'field_work_todo_description' => [
        'value' => "<p>" . date('Y') . " - Dethatch lawn as described</p>",
        'format' => 'full_html',
      ],
    ]);
    $work_order->save();
    ...
    // Implement the logic to create the dethatching work order.
