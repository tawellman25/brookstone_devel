 ...
 */
class DormantOilWorkOrderController extends ControllerBase {
   ...
   */
  public function createDormantOilWorkOrder($contract_id) {
    ...
    $dormant_oil_id = $contract->get('field_dormant_oil')->target_id;
    ...
    if (!$dormant_oil_section->get('field_work_order')->isEmpty()) {
    ...
    // Get the value of the 'field_dormant_oil_season' field from the Pre-emergent entity.
    $contract_season = $dormant_oil_section->get('field_dormant_oil_season')->target_id;
    ...
    $dormant_oil_section->set('field_work_order', $work_order_id);
    $dormant_oil_section->save();
