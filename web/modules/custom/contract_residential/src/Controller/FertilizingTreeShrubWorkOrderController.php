 ...
 */
class FertilizingTreeShrubWorkOrderController extends ControllerBase {

  /**
   * Creates a "Fertilizing Trees and Shrubs" work order for a given contract.
   *
   ...
   */
  public function createFertilizingTreeShrubWorkOrder($contract_id) {
    ...
    if (!$fertilizing_trees_and_shrubs_section) {
      $messenger->addError('Referenced Fertilizing Trees and Shrubs Section entity not found.');
      return;
    }
    ...
    // Implement the logic to create the fertilizing_trees_and_shrubs work order.
