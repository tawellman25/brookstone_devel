...
/**
 * @file
 * Contains \Drupal\sewards_hook_themer\Controller\SewAjaxController.
 */

namespace Drupal\sewards_hook_themer\Controller;
...
class SewAjaxController extends ControllerBase {

   public function sewards_ajax_view() {
      $view = $_REQUEST['view'];
      if($view){
