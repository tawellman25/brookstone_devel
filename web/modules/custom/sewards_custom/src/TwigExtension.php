...
namespace Drupal\sewards_hook_themer;
...
class TwigExtension extends AbstractExtension {
  ...
  public function getFunctions() {
    return [
      new TwigFunction('sew_drupal_view', 'views_embed_view'),
      new TwigFunction('sew_drupal_block', [$this, 'drupalBlock']),
      new TwigFunction('sew_drupal_token', [$this, 'drupalToken']),
      new TwigFunction('sew_drupal_entity', [$this, 'drupalEntity']),
      new TwigFunction('sew_drupal_field', [$this, 'drupalField']),
      new TwigFunction('sew_drupal_menu', [$this, 'drupalMenu']),
      new TwigFunction('sew_drupal_config', [$this, 'drupalConfig']),
      new TwigFunction('sew_theme_setting', [$this, 'themeSetting']),
    ];
  }
