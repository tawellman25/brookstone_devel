...
/**
 * Marks Work Order as Canceled.
 *
 * @Action(
 *   id = "mark_work_order_canceled_action",
 *   label = @Translation("Mark WO Canceled"),
 *   category = @Translation("Custom"),
 *   confirm = TRUE
 * )
 */
class MarkWorkOrderCanceledAction extends ViewsBulkOperationsActionBase {
  use MessengerTrait;
  ...
  public function execute(EntityInterface $entity = NULL) {
    if ($entity && $entity->getEntityTypeId() === 'work_order') {
      ...
      // Create a Status Update entry for Canceled.
      $wo_status_updates = \Drupal::entityTypeManager()
        ...
        ->create([
          ...
          'field_status' => 1098,
          'field_status_change_note' => "$currentUserName marked this Work Order as Canceled.",
          'uid' => $currentUserId,
        ]);

      $wo_status_updates->save();

      $messenger->addMessage("The Work Order #$workorder_id has been Marked as Canceled.");
    }
  }
