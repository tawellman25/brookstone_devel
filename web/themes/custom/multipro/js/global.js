...
(function ($, Drupal) {
  ...
  Drupal.behaviors.multi_pro = {
    attach: function (context, settings) {
      $(document).ready(function () {
        $(function () {
          $(".contact-1 .btn").removeClass(
            "btn-outline-primary btn-style-4 btn-lg white"
          );
          $(".contact-1 .btn").addClass("btn-primary btn-style-1 btn-lg");
        });
        ...
        $(".mega-menu").hover(
          ...
          function () {
            $(this).find(".dropdown-wrapper").removeClass("show");
          }
        );
        ...
        $(function () {
          ...
          $(".portfolio-details-slider .owl-dot").html(
            '<svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 36 36"><g id="Group_483" data-name="Group 483" transform="translate(-603.32 -8225.32)"><g id="Stroke" data-name="Rectangle 348" transform="translate(603.32 8225.32)" fill="none" stroke="#222025" stroke-width="1"><rect width="36" height="36" rx="18" stroke="none"/><rect x="0.5" y="0.5" width="35" height="35" rx="17.5" fill="none"/></g><rect id="innerDot" data-name="Rectangle 347" width="14" height="14" rx="7" transform="translate(614.32 8236.32)" fill="#222025"/></g></svg>'
          );
        });
        ...
        $(".portfolio_static").isotope({ layoutMode: "packery" });
        $(".masonry-style-3 .portfolio-lists").isotope({
          layoutMode: "packery",
        });
          ...
          function updateClock() {
            ...
            if (t.total <= 0) {
              ...
              document.getElementById("clockdiv").innerHTML =
                settings.custom_message_dateExpired;
            }
          }
          updateClock();
        ...
        function validate() {
          ...
          if (!$.trim(cnv)) {
            $(
              once("comment_form_validate", "form.comment-form textarea")
            ).after(
              '<span class="comment_error">Add Comment before Submission</span>'
            );
            return false;
          } else {
            return true;
