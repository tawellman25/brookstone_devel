...
if(!class_exists('element_sew_box_hover')):
   class element_sew_box_hover{
      ...
      public static function render_content( $attr = array(), $content = '' ){
         ...
         ob_start();
         ?>
         <div class="widget gsc-box-hover clearfix <?php print $el_class; ?>" <?php print $css ?> <?php print sewards_content_builder_print_animate_wow('', $animate_delay) ?>>
