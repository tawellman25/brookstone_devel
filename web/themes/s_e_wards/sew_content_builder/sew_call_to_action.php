...
if(!class_exists('element_sew_call_to_action')):
   class element_sew_call_to_action{
      ...
      function render_content( $attr = array(), $content = ''  ){
         ...
         ob_start();
         ?>
         <div class="widget gsc-call-to-action <?php print implode(' ', $class) ?>" <?php print $style ?> <?php print sewards_content_builder_print_animate_wow('', $animate_delay) ?>>
