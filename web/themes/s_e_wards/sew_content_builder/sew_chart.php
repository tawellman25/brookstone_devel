<?php 
if(!class_exists('element_sew_chart')):
   class element_sew_chart{
      ...
      public static function render_content( $attr = array(), $content = '' ){
         ...
         ob_start();
         ?>
         <div class="widget gsc-chart <?php print $el_class ?>" <?php print sewards_content_builder_print_animate_wow('', $animate_delay) ?>>
