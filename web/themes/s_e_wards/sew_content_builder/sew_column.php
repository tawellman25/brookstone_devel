	...
	public function render_content( $settings = array(), $content = '' ) {
      ...
      switch ($col_lg) {
        ...
        case 2: 
          ...
          break;
        case 3: 
          $default_col_lg = 3;$default_col_md = 3; $default_col_sm = 6; $default_col_xs = 12;
          break;
        case 4: 
        ...
        case 6: 
          ...
          break;
        case 7: 
          $default_col_lg = 7;$default_col_md = 12; $default_col_sm = 12; $default_col_xs = 12;
          break;
        case 8: 
          $default_col_lg = 8;$default_col_md = 12; $default_col_sm = 12; $default_col_xs = 12;
          break;
        case 9: 
        ...
        if(empty($col_lg_2)) $col_lg_2 = $default_col_lg;
         ...
         if($padding_top) $array_style[] 		= 'padding-top:'. intval( $padding_top ) .'px';
			...
			if( $bg_image){
              ...
              $class_col_parallax = 'sew-parallax-background';
            }else{
		...
		<div <?php if($id_column) print 'id="'.$id_column.'"' ?> class="gsc-column <?php print $column_class; ?>">
	      <div class="column-inner <?php print $column_class_inner ?>" <?php echo(($column_style) ? 'style="'.$column_style.'"' : '');  ?>>
	         ...
	         <?php if($bg_attachment == 'fixed'){ ?>
	           <div style="background-repeat: <?php print $bg_repeat; ?>;background-position:<?php print $bg_position ?>;" class="<?php print $col_bg_size ?> sew-parallax-inner skrollable skrollable-between" data-bottom-top="top: -60%;" data-top-bottom="top: 0%;"></div>
	         <?php } ?>
	      </div>
	    </div>
