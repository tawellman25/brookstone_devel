...
if(!class_exists('element_sew_gallery')):
   class element_sew_gallery{
      ...
      public static function render_content( $attr = array(), $content = '' ){
         ...
         ob_start();
         ?>
         <div class="gsc-our-gallery <?php echo $el_class ?>" <?php print sewards_content_builder_print_animate_wow('', $animate_delay) ?>> 
