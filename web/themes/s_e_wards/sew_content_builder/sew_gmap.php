<?php 
if(!class_exists('element_sew_gmap')):
   class element_sew_gmap{
         ...
         $fields = array(
            ...
            'fields' => array(
               ...
               array(
                  ...
                  'options'   => sewards_content_builder_animate(),
                  'class'     => 'width-1-2'
               ), 
               array(
                  'id'        => 'animate_delay',
                  ...
                  'options'   => sewards_content_builder_delay_wow(),
                  'desc'      => '0 = default',
                  'class'     => 'width-1-2'
               ), 
            ),                                     
      ...
      public static function render_content( $attr = array(), $content = '' ){
         ...
         $_id = sewards_content_builder_makeid();
       ...
       ob_start();
         ?>
         <script src="//maps.googleapis.com/maps/api/js?key=<?php echo $api_key ?>"></script>

         <script type="text/javascript" src="<?php print (base_path() . \Drupal::service('extension.list.theme')->getPath('s_e_wards')) ?>/vendor/gmap3.js"></script>
         <script type="text/javascript" src="<?php print (base_path() . \Drupal::service('extension.list.theme')->getPath('s_e_wards')) ?>/vendor/jquery.ui.map.min.js"></script>

         <div class="gsc-map <?php print $el_class ?>" <?php print sewards_content_builder_print_animate_wow('', $animate_delay) ?>>
