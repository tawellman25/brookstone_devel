<?php 
if(!class_exists('element_sew_heading')):
   class element_sew_heading{
      ...
      public static function render_content( $attr = array(), $content = '' ){
         ...
         ob_start();
         ?>
         <div class="widget gsc-heading <?php print implode(' ', $class) ?>" <?php print sewards_content_builder_print_animate_wow('', $animate_delay) ?>>
