<?php 
if(!class_exists('element_sew_icon_box_classic')):
   class element_sew_icon_box_classic{
      public function render_form(){
         $fields = array(
            'type' => 'element_sew_icon_box_classic',
            ...
            'fields' => array(
               ...
               array(
                  ...
                  'title'     => t('Icon class'),
                  'std'       => '',
                  'desc'     => t('Use class icon font <a target="_blank" href="http://fontawesome.io/icons/">Icon Awesome</a> or <a target="_blank" href="http://sewardsthemes.com/icons/ionicon/">Custom icon</a>'),
               ),
               array(
                  'id'        => 'image',
                  'type'      => 'upload',
      ...
      public static function render_content( $attr = array(), $content = '' ){
         ...
         <?php if($icon_position=='top-center' || $icon_position=='top-left' || $icon_position=='top-right' || $icon_position=='right' || $icon_position=='left'){ ?>
            <div class="widget gsc-icon-box <?php if(count($class)>0) print implode(' ', $class) ?>" <?php if(count($style) > 0) print 'style="'.implode(';', $style).'"' ?> <?php print sewards_content_builder_print_animate_wow('', $animate_delay) ?>>
