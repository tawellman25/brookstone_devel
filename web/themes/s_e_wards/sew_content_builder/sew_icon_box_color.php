...
if(!class_exists('element_sew_icon_box_color')):
   class element_sew_icon_box_color{
      ...
      public static function render_content( $attr = array(), $content = '' ){
         ...
         ob_start();
         ?>
         <div class="widget gsc-icon-box-color clearfix <?php print $el_class; ?>" <?php print sewards_content_builder_print_animate_wow('', $animate_delay) ?>>
