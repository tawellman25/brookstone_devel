...
if(!class_exists('element_sew_image_content')):
   class element_sew_image_content{
      ...
      public static function render_content( $attr = array(), $content = '' ){
         ...
         <?php if($skin == 'skin-v1'){ ?>
            <div class="gsc-image-content <?php print $el_class; ?>" <?php print sewards_content_builder_print_animate_wow('', $animate_delay) ?>>
               <?php if($title){ ?>
                  <h4 class="title">
