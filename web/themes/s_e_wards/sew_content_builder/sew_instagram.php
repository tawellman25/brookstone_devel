...
if(!class_exists('element_sew_instagram')):
   class element_sew_instagram{
      ...
      public static function render_content( $attr, $content = '' ){
         ...
         ob_start();
         ?>
         <div class="widget gsc-instagram <?php print $el_class; ?>" <?php print sewards_content_builder_print_animate_wow('', $animate_delay) ?>>
