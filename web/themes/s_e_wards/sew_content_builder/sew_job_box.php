<?php 
if(!class_exists('element_sew_job_box')):
   class element_sew_job_box{ 
      ...
      public static function render_content( $attr = array(), $content = '' ){
         ...
         ob_start();
         ?>
         <div class="widget sew-job-box clearfix <?php print $el_class; ?>" <?php print sewards_content_builder_print_animate_wow('', $animate_delay) ?>>
