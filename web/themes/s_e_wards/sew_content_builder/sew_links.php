<?php 
if(!class_exists('element_sew_links')):
   class element_sew_links{
      ...
      public static function render_content( $attr = array(), $content = '' ){
         ...
         ob_start();
         ?>
         <div class="gsc-links gv-sticky-menu <?php echo $el_class ?>" <?php print sewards_content_builder_print_animate_wow('', $animate_delay) ?>> 
