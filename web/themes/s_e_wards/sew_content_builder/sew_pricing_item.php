<?php
if(!class_exists('element_sew_pricing_item')):
   class element_sew_pricing_item{
      ...
      public static function render_content( $attr = array(), $content = '' ){
         ...
         ob_start();
         ?>
         <div class="pricing-table <?php print $el_class ?>" <?php print sewards_content_builder_print_animate_wow('', $animate_delay) ?>>
            <?php if($featured=='on'){ ?>
