<?php 
if(!class_exists('element_sew_progress')):
   class element_sew_progress{
      ...
      public static function render_content( $attr = array(), $content = '' ){
         ...
         ob_start();
         ?>
         <div class="widget gsc-progress<?php if(count($class_array)) print (' ' . implode(' ', $class_array)) ?>" <?php print sewards_content_builder_print_animate_wow('', $animate_delay) ?>>
