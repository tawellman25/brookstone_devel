			...
			'fields'	=> array(
		      ...
		      array(
		        ...
		        'options'   => array(
		          	...
		          	'padding-bottom-large-2'            => 'Padding Bottom Large II',
	...
	public function render_content( $settings = array(), $content = '' ) {
         ...
         $array_class[]	= $class;
			...
			if( $bg_image){
				...
				if($bg_attachment=='fixed'){
					$array_class[] = 'sew-parallax-background ';
				}
				if($bg_attachment=='bg-fixed'){
					$array_class[] = 'sew-fixed-background ';
				}
			}
		...
		<div class="gbb-row-wrapper">
			  ...
			  <?php if( $bg_attachment == 'fixed' ){ ?>
			    <div style="background-repeat: <?php print $bg_repeat; ?>;background-position:<?php print $bg_position ?>;<?php print ($bg_size=='width-100'?'background-size: 100%;':'')?>" class="sew-parallax-inner skrollable skrollable-between <?php print $row_bg_size ?>" data-bottom-top="top: -60%;" data-top-bottom="top: 0%;"></div>
			  <?php } ?>
			</div>  
		</div>
