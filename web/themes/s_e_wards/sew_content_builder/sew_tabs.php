<?php 
if(!class_exists('element_sew_tabs')){
   class element_sew_tabs{
      ...
      public static function render_content( $attr = array(), $content = '' ){
         ...
         ob_start() ?>
         <div class="gsc-tabs <?php print $el_class ?>" <?php print sewards_content_builder_print_animate_wow('', $animate_delay) ?>>
