<?php 
if(!class_exists('element_sew_video_box')):
   class element_sew_video_box{
      ...
      <?php if($style == 'style-1'){ ?>
         <div class="widget gsc-video-box <?php print $el_class;?> clearfix <?php print $style ?>" <?php print sewards_content_builder_print_animate_wow('', $animate_delay) ?>>
