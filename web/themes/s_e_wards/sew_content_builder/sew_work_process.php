<?php 
if(!class_exists('element_sew_work_process')):
   class element_sew_work_process{
      public function render_form(){
         $fields = array(
            'type'      => 'sew_work_process',
      ...
      public static function render_content( $attr = array(), $content = '' ){
         ...
         $_id = 'workprocess-' . sewards_content_builder_makeid();
         $classes = $el_class;

         ob_start();
         ?>
         <div class="gsc-workprocess <?php print $classes ?>" id="<?php print $_id; ?>" <?php print sewards_content_builder_print_animate_wow('', $animate_delay) ?>>
